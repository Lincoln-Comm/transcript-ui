...
import { LayoutGrid, Users, FileText, Settings, BookOpen, Shield } from 'lucide-react';
...
const Header = ({ activeNav = 'generate-transcript' }: HeaderProps) => {
  ...
  const navItems = [
    ...
    { 
      ...
      show: hasPermission('students', 'read')
    },
    { 
      id: 'courses', 
      label: 'Courses', 
      ...
      show: hasPermission('courses', 'read')
    },
    { 
      ...
      show: hasPermission('transcripts', 'read')
    },
    { 
      id: 'users', 
      label: 'Users', 
  ...
  return (
    <header className="relative">
      {/* Background Layer - separate div with overflow hidden */}
