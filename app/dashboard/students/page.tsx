...
function StudentGradesModal({
  ...
  const fetchCourses = useCallback(async () => {
    try {
      // Fetch all courses (increase limit to get all)
      const response = await getCoursesPaginated({ limit: 10000 });
      console.log('📚 Fetched courses:', response.courses.length);
...
function StudentsContent() {
  ...
  // Default IB grading scale (matching TranscriptPDF format)
  ...
  const handleDownloadTranscript = async (student: StudentAPIResponse) => {
    ...
    try {
      ...
      console.log('✅ Transcript downloaded for:', student.first_name, student.last_name);
    } catch (err) {
...
//   // Default IB grading scale
//   const defaultGradingScale = [
//     { grade: '7', lcsDescriptor: 'Excellent', descriptor: 'A consistent and thorough understanding of the required knowledge and skills, and the ability to apply them almost faultlessly in a wide variety of situations.' },
//     { grade: '6', lcsDescriptor: 'Very Good', descriptor: 'A consistent and thorough understanding of the required knowledge and skills, and the ability to apply them in a wide variety of situations.' },
//     { grade: '5', lcsDescriptor: 'Good', descriptor: 'A consistent and thorough understanding of the required knowledge and skills, and the ability to apply them in a variety of situations.' },
//     { grade: '4', lcsDescriptor: 'Satisfactory', descriptor: 'A general understanding of the required knowledge and skills, and the ability to apply them effectively in normal situations.' },
//     { grade: '3', lcsDescriptor: 'Mediocre', descriptor: 'Limited achievement against most of the objectives, or clear difficulties in some areas.' },
//     { grade: '2', lcsDescriptor: 'Poor', descriptor: 'Very limited achievement against all the objectives.' },
//     { grade: '1', lcsDescriptor: 'Very Poor', descriptor: 'Minimal achievement in terms of the objectives.' },
//   ];
